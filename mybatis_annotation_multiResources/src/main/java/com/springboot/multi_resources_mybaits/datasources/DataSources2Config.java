package com.springboot.multi_resources_mybaits.datasources;
...
@Configuration
@MapperScan(basePackages = "com.springboot.multi_resources_mybaits.mapper.map2", sqlSessionTemplateRef  = "secondarySqlSessionTemplate")
